<nav x-data="{ open: false }" class="bg-gray-900 border-b border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <span style="font-family: 'Press Start 2P', sans-serif;" class="text-sm text-white">
                            retro<span class="text-green-500">GAME</span>
                        </span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('home')" :active="request()->routeIs('home')" class="text-gray-200">
                        {{ __('Início') }}
                    </x-nav-link>
                    @auth
                    ...
                    @if(Auth::user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('usuarios.index')" :active="request()->routeIs('usuarios.*')" class="text-gray-200">
                            {{ __('Usuários') }}
                        </x-nav-link>
                    @endif
                    @endauth
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('home')" :active="request()->routeIs('home')" class="text-gray-200">
                {{ __('Início') }}
